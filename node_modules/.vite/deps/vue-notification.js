...
var require_dist = __commonJS({
  "node_modules/vue-notification/dist/index.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module === "object")
        ...
        exports["vue-notification"] = factory(require_vue());
      else
        root["vue-notification"] = factory(root["vue"]);
    })(exports, function(__WEBPACK_EXTERNAL_MODULE_20__) {
      return (
        /******/
        function(modules) {
          ...
          function(module2, __webpack_exports__, __webpack_require__) {
            ...
            var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(20);
          ...
          function(module2, __webpack_exports__, __webpack_require__) {
            ...
            var __WEBPACK_IMPORTED_MODULE_0__Notifications_vue__ = __webpack_require__(3);
            var __WEBPACK_IMPORTED_MODULE_0__Notifications_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Notifications_vue__);
            ...
            var Notify = {
              install: function install(Vue) {
                ...
                var notify = function notify2(params) {
                  if (typeof params === "string") {
                    params = { title: "", text: params };
                  }
                  if ((typeof params === "undefined" ? "undefined" : _typeof(params)) === "object") {
                    __WEBPACK_IMPORTED_MODULE_1__events__[
                      "a"
                      /* events */
                    ].$emit("add", params);
                  }
          ...
          function(module2, __webpack_exports__, __webpack_require__) {
            "use strict";
            Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
            var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__(2);
            var __WEBPACK_IMPORTED_MODULE_1__events__ = __webpack_require__(1);
            var __WEBPACK_IMPORTED_MODULE_2__util__ = __webpack_require__(9);
            var __WEBPACK_IMPORTED_MODULE_3__defaults__ = __webpack_require__(7);
            var __WEBPACK_IMPORTED_MODULE_4__VelocityGroup_vue__ = __webpack_require__(13);
            var __WEBPACK_IMPORTED_MODULE_4__VelocityGroup_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__VelocityGroup_vue__);
            var __WEBPACK_IMPORTED_MODULE_5__CssGroup_vue__ = __webpack_require__(12);
            var __WEBPACK_IMPORTED_MODULE_5__CssGroup_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__CssGroup_vue__);
            var __WEBPACK_IMPORTED_MODULE_6__parser__ = __webpack_require__(8);
            ...
            var Component = {
              ...
              props: {
                ...
                position: {
                  ...
                  default: function _default() {
                    return __WEBPACK_IMPORTED_MODULE_3__defaults__[
                      "a"
                      /* default */
                    ].position;
                  }
                ...
                animationName: {
                  type: String,
                  default: __WEBPACK_IMPORTED_MODULE_3__defaults__[
                    "a"
                    /* default */
                  ].cssAnimation
                },
              ...
              mounted: function mounted() {
                ...
                __WEBPACK_IMPORTED_MODULE_1__events__[
                  "a"
                  /* events */
                ].$on("close", this.closeItem);
              },
              computed: {
                actualWidth: function actualWidth() {
                  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__parser__[
                    "a"
                    /* default */
                  ])(this.width);
                },
                ...
                styles: function styles() {
                  var _listToDirection = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util__[
                    "a"
                    /* listToDirection */
                  ])(this.position), x = _listToDirection.x, y = _listToDirection.y;
                  var width = this.actualWidth.value;
                  var suffix = this.actualWidth.type;
                  var styles2 = _defineProperty({
                    width: width + suffix
                  }, y, "0px");
                  if (x === "center") {
                    styles2["left"] = "calc(50% - " + width / 2 + suffix + ")";
                  } else {
                    styles2[x] = "0px";
                  }
                  return styles2;
              ...
              methods: {
                ...
                addItem: function addItem(event) {
                  ...
                  var title = event.title, text = event.text, type = event.type, data = event.data, id = event.id;
                  var item = {
                    id: id || __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util__[
                      "b"
                      /* Id */
                    ])(),
                    title,
                  ...
                  var isDuplicate = this.active.some(function(item2) {
                    return item2.title === event.title && item2.text === event.text;
                  });
                ...
                enter: function enter(_ref) {
                  var el = _ref.el, complete = _ref.complete;
                ...
                leave: function leave(_ref2) {
                  var el = _ref2.el, complete = _ref2.complete;
          ...
          function(module2, __webpack_exports__, __webpack_require__) {
            ...
            var parse2 = function parse3(value) {
          ...
          function(module2, __webpack_exports__, __webpack_require__) {
            ...
            var split = function split2(value) {
            ...
            var listToDirection = function listToDirection2(value) {
              if (typeof value === "string") {
                value = split(value);
              }
              var x = null;
          ...
          /***/
          function(module2, exports2, __webpack_require__) {
            exports2 = module2.exports = __webpack_require__(11)();
            exports2.push([module2.i, ".vue-notification-group{display:block;position:fixed;z-index:5000}.vue-notification-wrapper{display:block;overflow:hidden;width:100%;margin:0;padding:0}.notification-title{font-weight:600}.vue-notification-template{background:#fff}.vue-notification,.vue-notification-template{display:block;box-sizing:border-box;text-align:left}.vue-notification{font-size:12px;padding:10px;margin:0 5px 5px;color:#fff;background:#44a4fc;border-left:5px solid #187fe7}.vue-notification.warn{background:#ffb648;border-left-color:#f48a06}.vue-notification.error{background:#e54d42;border-left-color:#b82e24}.vue-notification.success{background:#68cd86;border-left-color:#42a85f}.vn-fade-enter-active,.vn-fade-leave-active,.vn-fade-move{transition:all .5s}.vn-fade-enter,.vn-fade-leave-to{opacity:0}", ""]);
          },
          /* 11 */
          /***/
          function(module2, exports2) {
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            module2.exports = function(parentId, list, _isProduction) {
          ...
          /***/
          function(module2, exports2) {
            module2.exports = function listToStyles(parentId, list) {
              var styles = [];
              var newStyles = {};
          ...
          /***/
          function(module2, exports2) {
            module2.exports = __WEBPACK_EXTERNAL_MODULE_20__;
          }
          /******/
        ])
      );
...
vue/dist/vue.cjs.js:
  ...
  **)
*/
//# sourceMappingURL=vue-notification.js.map
